						...
						if (usi_app.check_sub_total_price(79) && usi_app.is_flexable) {
							...
							if (usi_app.is_cart_page) {
								...
								if (split_key == 'video') {
									...
									usi_commons.log('[ load ] * * * Load Footage Dynamic Cart Video BG [language key: ' + language_key + '] * * *');
								...
								if (split_key == 'video') {
									...
									usi_app.messaging = usi_app.get_messaging("footage_tenpercent");
									if (usi_app.messaging && usi_app.messaging.header1) {
										usi_commons.log('[ load ] * * * Load Footage Precise Promotion Static [language key: ' + language_key + '] * * *');
